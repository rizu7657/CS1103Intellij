...
public class SimpleParser3 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.print("\n?  ");
            Unit4.TextIO.skipBlanks();
            if ( Unit4.TextIO.peek() == '\n' )
                break;
            try {
                ...
                System.out.println("*** Discarding input:  " + Unit4.TextIO.getln());
            }
        }
    ...
    private static ExpNode expressionTree() throws ParseError {
        ...
        TextIO.skipBlanks();
        while ( Unit4.TextIO.peek() == '+' || TextIO.peek() == '-' ) {
                // Read the next term and combine it with the
                // previous terms into a bigger expression tree.
            char op = Unit4.TextIO.getAnyChar();
    ...
    private static ExpNode termTree() throws ParseError {
        ...
        term = factorTree();
        Unit4.TextIO.skipBlanks();
        while ( Unit4.TextIO.peek() == '*' || Unit4.TextIO.peek() == '/' ) {
