...
public class GuiDemo extends JFrame {
    ...
    public GuiDemo() {
        ...
        drawPanel.getTextItem().setJustify(TextItem.RIGHT);
        drawPanel.setBackgroundImage(Util.getImageResource("resources/images/bg_bruce.jpg"));
    ...
    private JToolBar createToolbar() {
        JToolBar toolBar = new JToolBar("Background Options");
    ...
    private class ChooseBackgroundAction extends AbstractAction {
        ...
        ChooseBackgroundAction(String text) {
            ...
            if (text.equals("Color...")) {
                BufferedImage colorIcon = new BufferedImage(32,32,BufferedImage.TYPE_INT_ARGB);
                ...
                putValue(Action.SMALL_ICON, Util.iconFromResource("resources/image/fileopen.png"));
