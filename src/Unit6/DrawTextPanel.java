...
public class DrawTextPanel extends JPanel {
	...
	private void doMenuCommand(String command) {
		if (command.equals("Save...")) { // save all the string info to a file
			...
			File saveFile = fileChooser.getOutputFile(this, "Select File Name To Save State", "savefile");
			if (saveFile == null)
				return;
			try {
				writeObjectToFile(theString, saveFile);
			} catch (Exception e) {
				JOptionPane.showMessageDialog(this,
						"Sorry, an error occurred while trying to save the program state:\n" + e);
			}

		} else if (command.equals("Open...")) { // read a previously saved file, and reconstruct the list of strings
			theString = readObjectFromFile(fileChooser.getInputFile(this, "Select file to load previous state"));
	...
	private void writeObjectToFile(ArrayList<DrawTextItem> toSave, File saveFile) {
